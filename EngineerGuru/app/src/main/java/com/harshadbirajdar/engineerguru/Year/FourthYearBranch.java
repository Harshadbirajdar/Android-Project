...
public class FourthYearBranch extends Fragment {
    private FirebaseFirestore firestore =FirebaseFirestore.getInstance();
    private CollectionReference collectionReference = firestore.collection("FourthYear");
    private BranchRecyclerViewAdpter branchRecyclerViewAdpter;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fourth_year_branch, container, false);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.fourthYearRecycler);
