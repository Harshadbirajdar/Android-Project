...
public class SecondYearBranch extends Fragment {
    private FirebaseFirestore firestore =FirebaseFirestore.getInstance();
    private CollectionReference collectionReference = firestore.collection("SecondYear");
    private BranchRecyclerViewAdpter branchRecyclerViewAdpter;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable final Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.second_year_branch, container, false);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.branchRecycler);
